...
procedure display_imgFromSurface(Image: TBpic; x, y, x1, y1, w, h: integer); overload;
procedure display_imgFromSurface(Image: TBpic; x, y: integer); overload;
...
procedure drawPngPic(Image: TBpic;x, y, w, h, px, py, mask: integer; maskvalue: smallint = 0); overload;
procedure drawPngPic(Image: TBpic; px, py, mask: integer; maskvalue: smallint = 0); overload;
...
procedure ZoomPic(scr: TBpic; angle: double; x, y, w, h: integer);overload;
...
begin
  ...
  case where of
    ...
    2:
      DrawBField;
    3:
      display_imgFromSurface(TITLE2_BEGIN_PIC.Pic, 0, 0);
    4:
      display_imgFromSurface(DEATH_PIC.Pic, 0, 0);
    6:
      display_imgFromSurface(TITLE1_BEGIN_PIC.Pic, 0, 0);
  end;
