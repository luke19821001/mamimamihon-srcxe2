...
function SDL_imageFilterAddByte(Src1 : PAnsiChar; Dest : PAnsiChar; length : integer; C : char ) : integer;
...
function SDL_imageFilterSubByte(Src1 : PAnsiChar; Dest : PAnsiChar; length : integer; C : char ) : integer;
...
function SDL_imageFilterShiftRight(Src1 : PAnsiChar; Dest : PAnsiChar; length : integer;  N : char ) : integer;
...
function SDL_imageFilterShiftRightUint(Src1 : PAnsiChar; Dest : PAnsiChar; length : integer;  N : char ) : integer;
...
function SDL_imageFilterMultByByte(Src1 : PAnsiChar; Dest : PAnsiChar; length : integer; C : char ) : integer;
...
function SDL_imageFilterShiftLeft(Src1 : PAnsiChar; Dest : PAnsiChar; length : integer;  N : char ) : integer;
