...
function BASS_MIDI_FontPack(handle:HSOUNDFONT; outfile,encoder:PAnsiChar; flags:DWORD): BOOL; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF}; external bassmididll;
function BASS_MIDI_FontUnpack(handle:HSOUNDFONT; outfile:PAnsiChar; flags:DWORD): BOOL; {$IFDEF MSWINDOWS}stdcall{$ELSE}cdecl{$ENDIF}; external bassmididll;
